...
def answer_three():
    ...
    #print(df_gold)
    max_diff=df_gold['Gold']-df_gold['Gold.1']
    #print(max_diff)
    total=df_gold['Gold']+df_gold['Gold.1']
    total=(max_diff/total).idxmax()
...
def answer_five():
    #test= census_df.where df[STNAME] =='Virginia'
    return census_df['STNAME'].value_counts().argmax()


    
    #test=census_df['COUNTY'].idxmax()
    #print(test)
    #test1=df.iloc('2999')
